...
<svelte:window bind:innerWidth={width} />
  ...
  >
    ...
    <SwiperSlide>
    		...
    		<a href={`/anime/episodio/${episode.anime}/${episode.episodeNumber}`} style="text-decoration: none;">
    	<div class="item">
    		<img src={episode.thumbnail} loading="lazy">
    		{#if episode.animeName && episode.animeName.length >= 25}
						<span class="title">{episode.animeName.substring(0, 25)}... - {episode.episodeNumber}</span>
...
<Swiper
  ...
  <style type="text/css">
  	...
  	a:hover .item:after, a:hover .play .button{
  		visibility: visible;
  		opacity: 1;
  	}
  	a:hover .title {
