...
<div
	style="max-width: 100%;height: 600px;background-image: linear-gradient(to  top   ,rgb(13,13,13) ,transparent), linear-gradient(to  right,rgb(13,13,13) ,transparent 80%),linear-gradient(to  left,rgb(13,13,13) ,transparent 30%),url({$all.data['animeRandom'].image});background-position: center;background-size: cover; "
>
	<NavBar />
