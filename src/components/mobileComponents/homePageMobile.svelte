...
{:else}
	...
	{#if !$all.fetching}
		<div
			style="width:100%;margin-bottom: 5px;margin-top: 10px;display: flex; justify-content: center; align-items: center; border-radius:5px; background: #590d08;"
		>
			<p style="font-weight: 600; margin:5px;">
